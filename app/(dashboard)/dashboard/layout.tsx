...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      <aside
        className={`fixed left-0 top-16 z-50 h-[calc(100vh-4rem)] w-[82%] max-w-[320px] bg-white border-r border-gray-100 shadow-2xl transform transition-transform duration-300 lg:hidden overflow-hidden ${
      ...
      {/* Desktop sidebar */}
      <aside
        className={`hidden lg:flex fixed left-0 top-0 h-full bg-white border-r border-gray-100 shadow-sm flex-col transition-all duration-300 z-40 ${
      ...
      {/* Main */}
      <div
        className={`flex min-h-screen flex-col transition-all duration-300 overflow-x-hidden ${
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="relative hidden sm:block min-w-0">
              ...
              <input
                ...
                className="w-56 md:w-64 lg:w-80 pl-9 pr-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition"
              />
            </div>
          </div>
